...
Future<void> initInputRecognizer() async {
  sl
    ..registerLazySingleton<InputRecognitionDataSource>(() => InputRecognitionDataSourceImpl())
    ..registerLazySingleton<InputRecognitionRepository>(() => InputRecognitionRepositoryImpl(datasource: sl()))
    ..registerFactory<RecognizeNumberUseCase>(() => RecognizeNumberUseCase(inputRecognitionRepository: sl()))
    ..registerFactory<InputRecognitionCubit>(() => InputRecognitionCubit(recognizeNumberUseCase: sl()));
}
